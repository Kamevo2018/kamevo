...
<head>
	...
	<link rel="stylesheet" href="../feedback/css/message.css">
	<link rel="stylesheet" href="../../css/style.max.css">
	<link rel="stylesheet" href="../../css/menu.css">
	<link rel="stylesheet" href="../../css/responsive.css">
	<link rel="stylesheet" href="../feedback/css/responsive.css">
...
<?php require('../../php/menu.php'); ?>
	<?php
		if(isset($_GET['message'])){
			$messageExist = $db->prepare('SELECT * FROM partnership WHERE id = ? ORDER BY id DESC');
			$messageExist->execute(array(htmlspecialchars($_GET['message'])));
			$exist = $messageExist->rowCount();
			if($exist > 0){
				while($message = $messageExist->fetch()){
					echo '<div class="message">
						<div class="message-header"><i class="fa fa-envelope" aria-hidden="true"></i> Message de : <b>'.$message['email'].'</b> - Le 07/11/2017</div><br/>
